...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Long Term accumulation</li>
</ol>
            ...
            <tbody>
                ...
                foreach ($emp_data as $pay) {
                    ...
                    <tr>
                        ...
                        <td><?= _format_money($this, $pay['long_term'],true); ?></td>
                        <td><strong><?= _format_money($this,$total += $pay['long_term'],true); ?></strong></td>
                        <?php $count +=1; ?>
                    </tr>
                    <?php } ?>
                    <?php
