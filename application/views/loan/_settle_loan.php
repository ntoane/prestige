...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Settle Loan</li>
</ol>
...
?>
                <h4 class="tile-title">Settle Loan for <i class="font-italic"><?php echo $emp_name->fullname; ?></i>
                </h4>
                <br>
                <div class="row">
                    <div class="col-md-12">
                        <form action="<?php echo base_url(); ?>loan/settled_loan" method="POST">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label h5" for="settlement_amount">Settlement
                                    Amount:</label>
                                <div class="col-sm-8">
